...
function slot0.GetFinishAchievements(slot0, slot1)
	...
	for slot7, slot8 in ipairs(slot1 or slot0.atlas:GetAchEntranceList()) do
		slot9, slot10 = slot0:CountAchievements(slot8)
		slot12 = {}

		for slot16, slot17 in ipairs(slot8:GetAchievementAwards()) do
			if not slot0:GetMapAchieveStarDic(slot8.id)[slot17.star] and slot17.star <= slot9 + slot10 then
