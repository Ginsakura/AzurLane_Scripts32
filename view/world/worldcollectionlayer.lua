...
function slot0.init(slot0)
	...
	slot0.scrollEntrance.onValueChanged:AddListener(function (slot0)
		uv0:UpdateJumpBtn()
	end)
...
function slot0.GetAwardIndex(slot0, slot1)
	if slot1 then
		for slot7 = 1, #slot0.achAwardIndexList do
			if slot0.scrollEntrance.value + slot0.entrancePos[#slot0.achEntranceList] - 1 < slot0.entrancePos[slot0.achAwardIndexList[slot7]] then
		...
		for slot7 = #slot0.achAwardIndexList, 1, -1 do
			if slot0.entrancePos[slot0.achAwardIndexList[slot7]] < slot0.scrollEntrance.value then
				return slot0.achAwardIndexList[slot7]
			end
		end
