...
function slot0.OnLoaded(slot0)
	...
	slot0.lessonTimeTxt = slot0:findTF("introl/timer_Text"):GetComponent(typeof(Text))
...
function slot0.GetLessons(slot0)
	slot1 = getProxy(BagProxy):getItemsByType(Item.LESSON_TYPE)
