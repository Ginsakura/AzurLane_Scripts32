...
function slot0.OnVote(slot0, slot1, slot2)
	...
	slot0.voteMsgBox:ExecuteAction("Open", slot3, slot0.contextData.voteGroup:GetRank(slot3), slot0:GetVotes(), defaultValue(slot2, false), function (slot0)
...
function slot0.initShips(slot0)
	...
	for slot6, slot7 in ipairs(slot0.contextData.voteGroup:GetRankList()) do
		if uv0.ShipIndex.typeIndex == ShipIndexConst.TypeAll and uv0.ShipIndex.rarityIndex == ShipIndexConst.RarityAll and uv0.ShipIndex.campIndex == ShipIndexConst.CampAll and slot7:IsMatchSearchKey(getInputText(slot0.search)) then
