...
function slot0.Refresh(slot0, slot1, slot2)
	if slot1.skinId == slot0.ship.skinId and slot1.id == slot0.ship.id and slot0.state == uv0.GetAssistantStatus(slot1) and slot0.bgToggle == PlayerPrefs.GetInt("paint_hide_other_obj_" .. slot0.painting.paintingName, 0) then
