...
function slot0.InitButton(slot0)
	for slot4 = 1, slot0.attrGroup.childCount do
		onButton(slot0, slot0.attrGroup:GetChild(slot4 - 1), function ()
	...
	for slot4 = 1, slot0.tachie.childCount do
		slot5 = slot0.tachie:GetChild(slot4 - 1)
		...
		onButton(slot0, slot5, function ()
			...
			uv0:ShowDialog(math.random(2, 4), function ()
...
function slot0.didEnter(slot0)
	...
	for slot6 = 1, slot0.scroll.childCount do
		PoolMgr.GetInstance():GetSpineChar(slot0.standAnim[slot2[slot6]], false, function (slot0)
...
function slot0.ShowDialog(slot0, slot1, slot2)
	...
	table.insert(slot0.LTList, LeanTween.scale(slot0.dialog, Vector3.New(1, 1, 1), uv0.DIALOG_TIME):setEase(LeanTweenType.easeOutSine).uniqueId)
	pg.CriMgr.GetInstance():PlaySoundEffect_V3("event:/cv/" .. slot0.wordsGroup[slot1][1], function (slot0)
...
function slot0.HideDialog(slot0)
	table.insert(slot0.LTList, LeanTween.scale(slot0.dialog, Vector3.New(0, 0, 0), uv0.DIALOG_TIME):setEase(LeanTweenType.easeOutSine):setOnComplete(System.Action(function ()
...
function slot0.IsShowRed()
	...
	for slot7, slot8 in pairs(slot0.data1_list) do
		if slot8 < 2 and pg.activity_event_pt_consume[1].target[slot7][slot8 + 1] <= slot0.data1 then
			return true
		end
	end
