...
function slot0.init(slot0)
	...
	slot1 = slot0._tf:Find("content/calc")
	...
	onButton(slot0, slot0._tf:Find("content/bottom/btn_cancel"), function ()
		uv0:closeView()
	end, SFX_CANCEL)
	onButton(slot0, slot0._tf:Find("content/bottom/btn_confirm"), function ()
