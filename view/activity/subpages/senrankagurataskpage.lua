...
function slot0.findUI(slot0)
	...
	for slot5, slot6 in ipairs(slot0.nameList) do
		slot8 = getImageSprite(slot0:findTF(slot6, slot0:findTF("IconList")))
	...
	for slot7, slot8 in ipairs({
		...
		slot0.hxSpriteDict[slot8] = getImageSprite(slot0:findTF(slot8, slot0:findTF("HXList")))
	end
	...
	for slot8 = 1, #slot0.nameList do
		slot9 = slot0:findTF(slot8, slot0:findTF("PosList", slot0.posPanel))
	...
	for slot9 = 1, #slot0.nameList do
		slot0.progressTFList[slot9] = slot0:findTF(slot9, slot0:findTF("Progress", slot0.taskPanel))
	end
...
function slot0.updateTaskList(slot0)
	for slot5, slot6 in ipairs(slot0.taskTFList) do
		slot8 = slot0.taskProxy:getTaskVO(slot0:getCurTaskIDList()[slot5])
...
function slot0.openTaskAni(slot0)
	...
	slot0:managedTween(LeanTween.value, nil, go(slot4), System.Action_float(function (slot0)
...
function slot0.updateLogText(slot0)
	...
	slot6 = slot0.activity:getConfig("config_id")
	slot7 = pg.activity_event_turning[slot6].total_num
	slot9 = pg.TimeMgr.GetInstance():DiffDay(slot1, pg.TimeMgr.GetInstance():GetServerTime()) + 1
	slot11 = ""
