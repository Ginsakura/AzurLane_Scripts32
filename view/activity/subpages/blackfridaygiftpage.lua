...
function slot0.OnInit(slot0)
	slot0.rtGift = slot0._tf:Find("AD/gift")
	slot0.rtFreeGift = slot0._tf:Find("AD/gift_free")
	slot1 = slot0._tf:Find("AD/days")
...
function slot0.OnDataSetting(slot0)
	...
	slot0.nday = math.min(#slot0.idLists[1], slot0.activity:getNDay())
...
function slot0.UpdateCard(slot0, slot1, slot2)
	...
	slot9 = pg.TimeMgr.GetInstance():STimeDescS(slot2:getTimeStamp(), "%m.%d")
