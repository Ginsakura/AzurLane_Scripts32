...
function slot0.findUI(slot0)
	...
	for slot7 = 1, 5 do
		table.insert(slot0.packetTFList, slot0:findTF("ContainerBehide", slot2):GetChild(slot7 - 1))
	end

	for slot8 = 1, 5 do
		table.insert(slot0.packetTFList, slot0:findTF("ContainerFront", slot2):GetChild(slot8 - 1))
	end
