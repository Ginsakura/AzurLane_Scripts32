...
slot1 = {
	...
	SixthAnniversaryIslandMediator = function (slot0, slot1)
		if not getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_ISLAND) or slot2:isEnd() then
	...
	SixthAnniversaryIslandShopMediator = function (slot0, slot1)
		if underscore.detect(getProxy(ActivityProxy):getActivitiesByType(ActivityConst.ACTIVITY_TYPE_SHOP), function (slot0)
