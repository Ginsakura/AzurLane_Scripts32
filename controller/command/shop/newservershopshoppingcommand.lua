...
function slot0.execute(slot0, slot1)
	...
	if DROP_TYPE_ITEM == slot17 and pg.item_data_statistics[slot18].type == Item.EXP_BOOK_TYPE and pg.item_data_statistics[slot18].max_num < getProxy(BagProxy):getItemCountById(slot18) + slot19 * slot8 then
