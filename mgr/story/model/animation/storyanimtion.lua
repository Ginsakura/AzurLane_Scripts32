...
function slot0.moveLocalPath(slot0, slot1, slot2, slot3, slot4, slot5, slot6)
	...
	for slot11, slot12 in ipairs(slot2) do
		System.Array.CreateInstance(typeof(UnityEngine.Vector3), #slot2)[slot11 - 1] = slot12
	end

	slot0:DelayCall(slot4, function ()
		if uv4 then
			LeanTween.moveLocal(uv0.gameObject, uv1, uv2 * uv3.timeScale):setOnComplete(System.Action(uv4))
		end
