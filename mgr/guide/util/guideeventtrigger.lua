...
function slot0.HandleStickTrigger(slot0, slot1, slot2, slot3)
	GetOrAddComponent(slot1, typeof(EventTriggerListener)):AddPointDownFunc(function (slot0, slot1)
		if IsNil(uv0) then
			return
		end
...
function slot0.HandleShowUITrigger(slot0, slot1, slot2, slot3)
	GetOrAddComponent(slot1, typeof(EventTriggerListener)):AddPointUpFunc(function (slot0, slot1)
		if IsNil(uv0) then
			return
		end
